...
class DataModule(pl.LightningDataModule):
    def __init__(self, num_workers: int, batch_size: int, data_dir: str, retrain_on_all: bool, **kwargs):
        ...
        # Create datasets.
        self.train_set = PoseDataset('train', data_dir, retrain_on_all)
        self.val_set = PoseDataset('val', data_dir, retrain_on_all)
        self.test_set = PoseDataset('test', data_dir, retrain_on_all)
